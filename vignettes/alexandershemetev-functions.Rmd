...
library(RColorBrewer)
 ...
 library(alexandershemetev, lib.loc = "C:/Users/Alex/Documents/NewRPackage/alexandershemetev/alexandershemetev/")
...
For this walk-through I will use the data set mtcars, which comes with the basic R environment. ``` {r variables}
kable(data.frame(mtcars))
```
## Descriptive Statistics

```{r descriptive_statistics_table_winsorized}
alex_dataframe_descriptive_table(mtcars, showdf = TRUE)
```
...
Take look at the [github repository of the ExPanDaR package](https://github.com/Alexandershemetev?tab=repositories) for the codes.
Have fun!
